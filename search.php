...
function run_login_script($panel, $cookie_file)
{
    ...
    if ($response === false)
        die("خطا در اجرای مرحله ورود به پنل: " . curl_error($ch));
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($response === false)
        die("خطا در اجرای مرحله جستجو: " . curl_error($ch));
    $json_response = json_decode($response, true);
    if (!$json_response)
        die("خطا در تحلیل پاسخ JSON");
    ...
    <div class="card" style="background-color: #2b34428a;border-radius: 15px;">
        <div class="card-body " style="display: flex;justify-content: space-between">
            <a class="card-link l1">
                <svg style="margin-left: 4px" fill="#f0ebd8" xmlns="http://www.w3.org/2000/svg" height="1em"
                     viewBox="0 0 640 512">
    ...
    <div class="flex-container">
        <div class="flex-item">
            ...
            <p class="card-text car-2 text-center">
                <svg style="margin-left: 4px" fill="#f1faee" xmlns="http://www.w3.org/2000/svg" height="1em"
                     viewBox="0 0 576 512">
...
<div class="container">
    ...
    <div class="flex-container">
        <a href="https://sourceforge.net/projects/netmodhttp/" class="flex-item1">
            <div>
                NetMod
                <svg style="margin-left: 10px;font-size: 21px;" fill="#f1faee" xmlns="http://www.w3.org/2000/svg"
                     width="22px" height="22px" viewBox="0 0 384 512">
        ...
        <a href="https://github.com/2dust/v2rayNG/releases/download/1.8.5/v2rayNG_1.8.5.apk" class="flex-item1">
            <div>
                V2rayNG
                <svg style="margin-left: 10px" fill="#f1faee" xmlns="http://www.w3.org/2000/svg" width="22px"
                     height="22px" viewBox="0 0 576 512">
